...
function App() {
  ...
  return (
    <div className="App">
      ...
      <NavBar />
      <Routes>
        <Route path='/' exact element={<LOG_IN />} />
        <Route path='/dashbord' exact element={<Dashbord />} />
        <Route path='/student-union' exact element={<StudentsUnion />} />
        <Route path='/student-union/leader' exact element={<SuLeaders />} />
        <Route path='/student-union/candidate' exact element={<SuCandidate />} />
        <Route path='/student-union/voting' exact element={<SuVoting />} />
